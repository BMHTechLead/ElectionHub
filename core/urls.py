...
urlpatterns = [
  ...
  path("elections/<int:election_id>/special/unit/<int:unit_id>/", views.special_unit_detail, name="special_unit_detail"),
  path("elections/<int:election_id>/data/", views.election_data_management, name="election_data_management"),
